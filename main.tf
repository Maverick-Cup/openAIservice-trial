...
resource "azurerm_storage_account" "storage_account" {
  ...
  #name                     = var.storage_account_id               # The ID of the storage account
  ...
  account_kind             = var.storage_account_kind             # The kind/type of the storage account (e.g., "BlobStorage" "BlockBlobStorage" "FileStorage" "Storage" "StorageV2")
  ...
  lifecycle {
    # Ignore changes to some resources to avoid unnecessary updates, deletion and recreation.
    prevent_destroy = true
    ignore_changes  = all
  }
}
